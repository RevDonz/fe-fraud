						...
						<>
							...
							<ModalBody>
								<p className="text-danger-500">
									...
									itikad baik dan sepenuh hati. Saya berkomitmen untuk
									memberikan jawaban yang sejelas dan seakurat mungkin, tanpa
									menggunakan bantuan pihak lain atau materi yang tidak
									diizinkan. Kejujuran saya dalam mengisi assessment ini adalah
									landasan untuk pengembangan diri saya.
								</p>
							</ModalBody>
