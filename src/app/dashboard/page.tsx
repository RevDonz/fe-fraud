			...
			<Card className="p-3">
				<CardHeader>
					<p className="text-primary-500 text-justify">
						Selamat datang di halaman Dasboard. Anda masuk sebagai Admin. Untuk
						memastikan pengalaman pengguna yang lancar, berikut adalah panduan
						singkat untuk menggunakan fitur-fitur utama aplikasi ini:
					</p>
				</CardHeader>
				<CardBody>
							...
							<CardBody>
								<div className="flex flex-col gap-3 text-justify">
									<p>
										...
										isi. Dengan metode Fraud Deterrence Propeller, Fraud
										Assesment mempunyai 6 indikator, yaitu :
									</p>
									<ol className="list-outside list-decimal pl-4">
										...
										<p className="mb-3">
											Indikator dalam membangun tata kelola dan tindakan
									...
									<p>
										...
										dengan itu, entitas dapat mengetahui indikator mana yang
										belum terpenuhi, dan sudah terpenuhi.
									</p>
								</div>
							</CardBody>
						</Card>
