		...
		component: (
			<CardBody>
				<div className="flex flex-col gap-5">
					<Card className="p-3" shadow="sm">
						<CardHeader>
							<p className="font-semibold">1. Penilaian Fraud Assesment</p>
						</CardHeader>
						<Divider />
						<CardBody>
							<div className="flex flex-col gap-3 text-justify">
								<p>
									Pada fitur Penilaian Fraud Assesment, Reviewer menilai
									Assesment yang sudah di isi oleh Admin / Owner. Anda menilai
									berdasarkan 6 Indikator, yaitu :
								</p>
								<ol className="list-outside list-decimal pl-4">
									<li>Due Dilligent</li>
									<p className="mb-3">
								...
								<p>
									Penilaian dilakukan dengan cara memvalidasi setiap pertanyaan
									dengan bukti yang ada, apabila benar, maka beri nilai benar,
									dan apabila salah, beri nilai salah.
								</p>
							</div>
						</CardBody>
					</Card>
